...
class Indication
{
  public:
     ...
     */
    explicit Indication(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Indication(const Json::Value &pJson) noexcept(false);
     ...
     */
    Indication(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<Indication>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Indication>;
#endif
