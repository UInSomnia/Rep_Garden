...
class Role
{
  public:
    ...
    const uint64_t &getValueOfPermission() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<uint64_t> &getPermission() const noexcept;
    ///Set the value of the column permission
    void setPermission(const uint64_t &pPermission) noexcept;
  ...
  private:
    ...
    std::shared_ptr<uint64_t> permission_;
    struct MetaData
    {
